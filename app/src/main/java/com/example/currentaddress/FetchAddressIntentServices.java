    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (intent != null) {
            ...
            if (addresses == null || addresses.size() == 0) {
                ...
                String str_address_new = address.getAddressLine(0);
                devliverResultToRecevier(Constants.SUCCESS_RESULT, str_address, str_locality, str_district, str_state, str_Country, str_postcode,str_address_new);
            }
        }

    }

    private void devliverResultToRecevier(int resultcode, String address, String locality, String district, String state, String country, String postcode,String str_address_new) {
        ...
        bundle.putString(Constants.FUll_ADDRESS, str_address_new);
